...
/* takes a string str containing a hexadecimal number,
   converts it to an unsigned 8-bit integer (unsigned char),
   and stores the result in the memory pointed to by the x pointer.
   If the value is greater than 0xFF (255). */
